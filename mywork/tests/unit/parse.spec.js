...
//     expect(JSON.stringify(parse(`# comment
//             Step welcome
...
//         Step complainProc
//         Exit`);
//     }).toThrow("Expected step, speak, listen, branch, silence, default, or exit. At Line: 2");
// });
...
//     expect(JSON.stringify(parse(`Step welcome
//     Speak $name + "您好，请问有什么可以帮您?"
//     Listen 5
//     Branch "充值", chargeProc
//     Branch "投诉", complainProc
